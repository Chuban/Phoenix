[Mesh]
  type = FileMesh
  file = ../meshes/WAXTS_Channel_Half.e
  dim = 2
[]
...
[Functions]
  [./rhou_inlet_func]
    type = ParsedFunction
    value = '(-4 * (10 * (y+0.075) - 0.5)^2 + 1) * 1.161 * 34.7'
  [../]
[]

[BCs]
  active = 'rhoE_thermal rho_neumann rhou_dirichlet rhov_neumann rhou_neumann rhov_dirichlet rhoE_neumann'
  [./rhov_dirichlet]
    type = DirichletBC
    variable = rhov
    boundary = 'top bottom'
